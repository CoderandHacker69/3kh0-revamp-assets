...
I hope you all are doing well. I have some sad news to bring to you all. 3kh0.net will be shutting down, effective immediately. This was not a choice made lightly, and I would HIGHLY recommend that you read this document about why and the future of it: https://rentry.co/3kh0. I also suggest that you join [the discord server](https://discord.gg/3kh0) as we will have more stuff planned there. As for this repo, it has been archived for preservation and storage. You are free to use these games however you see fit. If you wish, you can give credit. Thank you.



# 3kh0 Assets
![GitHub repo file count](https://img.shields.io/github/directory-file-count/CoderandHacker69/3kh0-revamp-ssets?label=Total%20file%20count)
